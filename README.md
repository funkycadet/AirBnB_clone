...
The console was developed in Ubuntu 20.04.5LTS using python3 (version 3.8.10).

### Further information :bookmark_tabs:
For further information on Python version, and documentation visit [python.org](https://www.python.org/).

## Requirements :memo:
Knowledge in Python3, how to use a command line interpreter, a computer with Ubuntu 20.04, Python3 and pep8 style validation.
...
* [Eric Alaribe](https://www.github.com/smith2eric)
* Natinael Seifu 
